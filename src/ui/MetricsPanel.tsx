  ...
  return (
    <div className="metrics">
      ...
      <div className="equity-line">
        no car of their own: {carless === null ? '—' : carless === 0 ? 'no data' : carlessText(carless, busRuns)}
      </div>
      ...
      {probe && (
        <div className="probe">
          ...
          <div className="muted">
            ...
            {Math.round(probe.n)} of {Math.round(probe.storage)} · load {(probe.load * 100).toFixed(0)}%
          </div>
        </div>
      )}
    </div>
